...
interface SuspectPhysicalDescriptionProps {
  form: UseFormReturn<ReportFormData>;
}

const SuspectPhysicalDescription = ({ form }: SuspectPhysicalDescriptionProps) => {
  return (
...
export default SuspectPhysicalDescription;
